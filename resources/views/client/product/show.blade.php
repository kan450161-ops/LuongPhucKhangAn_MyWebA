...
<div class="row g-4">
    <div class="col-md-5">
        ...
        <div class="row g-2">
            ...
            <div class="col-3">
                <img src="{{ asset('storage/products/' . $image->image) }}" class="img-fluid rounded border shadow-sm">
            </div>
            @endforeach
        </div>
    </div>
    <div class="col-md-7">
        ...
        <p><strong>Thương hiệu:</strong>
            <a href="{{ route('products.brand', ['slug' => $product->brand->slug]) }}">
...
<div class="row">
    ...
    <div class="col-md-3 mb-4">
        <div class="card h-100 shadow-sm">
            <img src="{{ asset('storage/products/' . ($item->image ?? 'default.png')) }}" class="card-img-top"
            ...
            <div class="card-body">
                ...
                <a href="{{ route('products.show', ['slug'=>$item->slug]) }}" class="btn btn-primary btn-sm">
                    Xem chi tiết
                </a>
            </div>
        </div>
